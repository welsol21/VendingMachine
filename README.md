...
- `docs/architecture-notes.md`
This document describes the architectural assumptions, boundaries, and implementation direction used to guide the code generation and development process.
## Status
